...
import qualityLifecycleImage from '../assets/quality-lifecycle.png'; // Adjust the path based on your project structure
  ...
  return (
    <div className="main-content">
      <div className="section">
        <h1 className="section-title">Our Editorial Guidelines: Providing Reliable Career Advice</h1>
        ...
        <p className="section-text">
          Each day, we analyze hiring trends & research, browse through workforce reports, and monitor job market forecasts to ensure you get all the information you need to write a professional resume, create a job-winning cover letter, ace your job application process, and prepare for a job interview.
        </p>
      </div>
      ...
      <div className="section">
        <h2 className="section-title">Our Editorial Quality Lifecycle</h2>
        <p className="section-text">
        ...
        <p className="section-text">
          <strong>Sign of Excellence:</strong> Zety’s career advice and expert insights have been recognized by over 200 universities, organizations, and prime media outlets from around the world. Examples include Maryville University, Santa Clara University, Allegany College of Maryland, University of Rochester, Forbes, The Financial Times, Career Builder, and Life Hacker.
        </p>
        <p className="section-text">
        ...
        <ul className="publication-list">
          <li><a href="https://www.businessinsider.in/careers/news/how-to-write-a-rsum-that-gets-you-hired-in-an-uncertain-economy/articleshow/97333930.cms" className="blue-link">"How to write a résumé that gets you hired in an uncertain economy"</a></li>
          <li><a href="https://www.aarp.org/retirement/planning-for-retirement/info-2021/enjoy-living-more-worry-less-about-money.html" className="blue-link">"7 Ways to Enjoy Retirement With Less Worry Over Money"</a></li>
          <li><a href="https://www.forbes.com/sites/bernadettejoy/2023/06/16/i-saved-enough-money-to-retire-by-age-37-heres-what-was-surprising/" className="blue-link">"I Saved Enough Money To Retire By Age 37. Here’s What Was Surprising"</a></li>
          <li><a href="https://studentscholarships.org/articles/309/on-scholarship-at-a-prestigious-college-heres-how-you-can-afford-your-living-expenses" className="blue-link">"On Scholarship at a Prestigious College? Here’s how you can afford your Living Expenses"</a></li>
          <li><a href="https://www.theguardian.com/business/2022/mar/20/great-resignation-great-regret-employees-quitting" className="blue-link">"Turns out the Great Resignation may be followed by the Great Regret"</a></li>
          <li><a href="https://www.forbes.com/councils/forbestechcouncil/2023/03/23/is-there-a-doctor-in-your-sales-house/" className="blue-link">"Is There A Doctor In Your Sales House?"</a></li>
          <li><a href="https://www.forbes.com/sites/tracybrower/2022/10/10/gender-stereotypes-still-matter-at-work-but-new-data-shows-progress/?sh=1a94cbd03f3c" className="blue-link">"Gender Stereotypes Still Matter At Work But New Data Shows Progress"</a></li>
        </ul>
      </div>
